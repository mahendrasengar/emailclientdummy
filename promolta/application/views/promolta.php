<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" ng-cloak="">
	...
	<div ng-if="userLoggedIn" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="app-btns col-xs-12 col-sm-4 col-md-3 col-lg-3">
			<button class="button_blue col-xs-12 col-sm-12 col-md-12 col-lg-12" ng-click="compose()">Compose</button>
			<button class="button_blue col-xs-12 col-sm-12 col-md-12 col-lg-12" ng-click="inbox()">Inbox</button>
			<button class="button_blue col-xs-12 col-sm-12 col-md-12 col-lg-12" ng-click="sent()">Sent</button>
			<button class="button_blue col-xs-12 col-sm-12 col-md-12 col-lg-12" ng-click="drafts()">Drafts</button>
			<button class="button_blue col-xs-12 col-sm-12 col-md-12 col-lg-12" ng-click="trash()">Inbox Trash</button>
			<button class="button_blue col-xs-12 col-sm-12 col-md-12 col-lg-12" ng-click="logout()">Log out</button>
		</div>
